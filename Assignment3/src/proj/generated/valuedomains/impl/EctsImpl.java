 ...
 */
public class EctsImpl extends Ects implements IValueInstance
{
    ...
    /**
     * Compare this Ects to another Ects
     * @param ects  The Ects to compare with
     * @return      A negative integer, zero, or a positive integer as this
     *              Ects is less than, equal to, or greater than the specified
     *              Ects
     */
    public int compareTo(Ects ects)
    {
        return edma_domain.valueCompare(value, ((EctsImpl) ects).value);
    }
