...
See [here](https://github.com/Hold-Krykke-BA/DBD/tree/main/Assignment2/task2/src) for an ultra simple implementation, using the Java BitSet (with 64 bits) instead of a long to avoid bit shifting.
